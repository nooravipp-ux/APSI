            ...
            <div class="col-md-6">
                <div class="program">
                    <div class="program-body">
                        ...
                        <div class="d-block mb-4 thumbnail"><img src="data:image/png;base64, {{$post_detail->banner}}"
                                alt="Image" style="width:800px;height:400px;" class="img-fluid">
                        </div>
                        
                        <p><a href="{{url('/')}}">APSI JABAR</a> with {{$post_detail->username}} <span class="mr-4 mb-5"><span class="icon-schedule icon"></span>{{date('d M Y',strtotime($post_detail->published_at))}}</span>
                            <span> <span class="icon-signal icon"></span> {{$post_detail->kategori}}</span></p>
