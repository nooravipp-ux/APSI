            ...
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.html" class="site_title"><span>APSI JABAR</span></a>
                    </div>
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="{{asset('landingpage/images/logo.jpg')}}" alt="..."
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-users"></i>Users Management<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="index.html">Data Users</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-child"></i>Management Anggota<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a>Members<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu">
                                                <li><a href="{{url('/admin/pendaftaran-bujp')}}">Satpam</a>
                                                </li>
                                                <li><a href="{{url('/admin/pendaftaran')}}">BUJP</a>
                                                </li>
                                            </ul>
                                        </li>
                                ...
                                <li><a><i class="fa fa-users"></i>Berita & Events<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-cloud-upload"></i>Gallery<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true"
                                    ...
                                    <img src="{{asset('landingpage/images/logo.jpg')}}" alt="">{{ Auth::user()->username }}
                                </a>
